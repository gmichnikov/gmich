...
PROJECTS = [
    ...
    {
        "id": "battleship_online",
        "name": "Battleship Online",
        "description": "Sink your opponent's fleet in a shareable head-to-head room",
        "url": "/battleship-online",
        "auth_required": False,
        "status": "active",
        "type": "project",
        "parent": "live_multiplayer_games",
    ...
    {
        "id": "live_multiplayer_games",
        "name": "Live Multiplayer Games",
        "description": "Play classic games with a friend anywhere via a shareable link",
        "url": "/live-multiplayer-games",
        "auth_required": False,
        "status": "active",
        "type": "category",
        "icon": "🌐",
    ...
    },
    {
        "id": "nfl_survivor",
        "name": "NFL Survivor",
        "description": "Annual NFL survivor pool — pick a team each week, don't pick them twice",
        "url": "/nfl-survivor",
        "auth_required": True,
        "status": "active",
        "type": "project",
    ...
    },
    {
        "id": "adk_agent_demo",
        "name": "ADK Agent Demo",
        "description": "Multi-agent orchestration demo using Google ADK",
        "url": "/adk-agent-demo",
        "auth_required": True,
        "status": "active",
        "type": "project",
