...
def create_app():
    ...
    from app.projects.ivy_burrito_feed.routes import ivy_burrito_feed_bp
    ...
    from app.projects.dice_roll.routes import dice_roll_bp
    ...
    from app.projects.kids_ai.routes import kids_ai_bp
    ...
    app.register_blueprint(dice_roll_bp, url_prefix="/dice-roll")
    ...
    app.register_blueprint(kids_ai_bp)
    ...
    from app.projects.sports_schedules.commands import (
